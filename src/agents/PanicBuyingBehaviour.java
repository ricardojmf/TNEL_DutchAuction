...
/*
 * " "panic buying" tactic is: "as the price decreases, if you see that a large number of items 
 * are sold, and your valuation is not met, then it might mean that your valuation is too low. 
 * Adjusting your valuation up will permit you to buy at least the minimum quantity."
 * Notice that the risk of missing the minimum quantity is small, but the risk of the winner's curse is high. "
*/
public class PanicBuyingBehaviour extends SimpleBehaviour {

	public PanicBuyingBehaviour(Agent a) {
		super(a);
	}
